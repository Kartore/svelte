...
{:else if type === 'hillshade' || type === 'color-relief' || type === 'raster' || type === 'heatmap' || type === 'fill'}
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" {...props}>
		<path
			d="M 2.84978,9.763512 9.462149,4.7316391 16.47225,9.478015 9.859886,14.509879 2.84978,9.763512 m -1.028761,0.492069 7.414535,5.020197 c 0.372277,0.25206 0.958697,0.239771 1.30985,-0.02745 L 17.539255,9.926162 C 17.89041,9.658941 17.873288,9.238006 17.501015,8.985946 L 10.08648,3.9657402 C 9.714204,3.7136802 9.127782,3.7259703 8.776627,3.9931918 L 1.782775,9.315365 c -0.3511551,0.267221 -0.3340331,0.688156 0.03824,0.940216 l 0,0 z"
		/>
	</svg>
{:else if type === 'line'}
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" {...props}>
...
{:else if type === 'symbol'}
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" {...props}>
		<g transform="matrix(1.2718518,0,0,1.2601269,16.559526,-7.4065264)">
			<path
				d="m -9.7959773,11.060163 c -0.3734787,-0.724437 -0.3580577,-1.2147051 -0.00547,-1.8767873 l 8.6034029,-0.019416 c 0.39670292,0.6865644 0.38365934,1.4750693 -0.011097,1.8864953 l -3.1359613,-0.0033 -0.013695,7.1305 c -0.4055357,0.397083 -1.3146432,0.397083 -1.7769191,-0.02274 l 0.030226,-7.104422 z"
			/>
		</g>
	</svg>
{:else}
